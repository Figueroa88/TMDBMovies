package com.alejandro.tmdbmovies.presentation.movieList.topRated
 ...
 *
 * FRAGMENT para el manejo del listado de las peliculas TOP RATED
 */
@AndroidEntryPoint
class MovieTopListFragment : BaseMovieListFragment()
{
    ////////////////////////////
    ///                      ///
    ///       OVERRIDE       ///
    ...
    {
        val action = MovieTopListFragmentDirections.actionTopToDetail(
            movie.posterPath,
            movie.backdropPath,
            movie.title,
            movie.overview,
