...
class MoviePopularListFragment : BaseFragment(R.layout.f_movie_list), MovieAdapter.IItemClickListener
{
    ...
    {
        val action = MoviePopularListFragmentDirections.actionPopularToDetail(movie.posterPath, movie.backdropPath, movie.title, movie.overview, movie.originalLanguage, movie.releaseDate)
